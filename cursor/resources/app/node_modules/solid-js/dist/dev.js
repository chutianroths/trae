...
function readSignal() {
  ...
  if (Listener) {
    ...
    if (!this.observers) {
      ...
      if (DEV && this.observers.length > 1000 && this.observers.length % 100 === 0) {
        const trace = new Error().stack?.split('\n').slice(1).join('\n');
        console.warn(`solid signal has`, this.observers.length, "observers for value:", this.value, this, trace);
        postMessage({
