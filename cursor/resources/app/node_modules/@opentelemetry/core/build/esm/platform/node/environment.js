...
export function getStringListFromEnv(key) {
    return getStringFromEnv(key)
        ...
        .map(v => v.trim())
        .filter(s => s !== '');
}//# sourceMappingURL=http://go/sourcemap/sourcemaps/56f0a83df8e9eb48585fcc4858a9440db4cc7770/node_modules/@opentelemetry/core/build/esm/platform/node/environment.js.map