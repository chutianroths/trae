...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
    ...
    if (options.anrDetection) {
        ...
        const integration = eventLoopBlock.eventLoopBlockIntegration(integrationOptions);
...
exports.init = init;//# sourceMappingURL=http://go/sourcemap/sourcemaps/9d178a4a5589981b62546448bb32920a8219a5d0/node_modules/@sentry/electron/renderer/sdk.js.map
