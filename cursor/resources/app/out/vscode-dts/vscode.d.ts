...
declare module 'vscode' {
	...
	export interface FileSystem {
		...
		/**
		 * Resolve the real path of a file or directory, resolving any symbolic links.
		 *
		 * @param uri The uri of the file or directory to resolve.
		 * @returns The real path uri with all symbolic links resolved.
		 */
		realpath(uri: Uri): Thenable<Uri>;
